...
*  @throws  ValeurImpossibleException  si  la  valeur
*  est  interdite  aux  vues  des  autres  valeurs  de  la  grille
*  @throws  CaractereInterditException  si  value
*  n'est  pas  un  caractere  autorise  ('1',...,'9')
*/
void  setValue(int  x,  int  y,  char  value) throws  HorsBornesException,
...
*  @param  value  valeur  a  mettre  dans  la  case
*  @throws  HorsBornesException  si  x  ou  y  sont  hors  bornes  (0-8)
*  @throws  CaractereInterditException  si  value  n'est  pas  un
*  caractere  autorise  ('1',  ...,  '9',  ...)
*  @return retourne un boolean
*/
boolean  possible(int  x,  int  y,  char  value)  throws  HorsBornesException,
